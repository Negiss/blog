...
";
    ...
    {
        return array (  87 => 16,  80 => 12,  72 => 6,  63 => 5,  45 => 3,  15 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"example-wrapper\">
        ...
        Get your lucky number at :
        <ul>
            <li><a href=\"{{ path('lucky') }}\">Lucky luck !</a></li>
        </ul>
        Or come visit :
        <ul>
            <li><a href=\"{{ path('blog_home') }}\">My blog</a></li>
        </ul>
    </div>

{% endblock %}
", "home/home.html.twig", "/home/wilder/PhpstormProjects/SymfonyBlog/blog/templates/home/home.html.twig");
    }
}
